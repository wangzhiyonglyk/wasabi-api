...
//导出对象
export { paramFormat,ajax,secret,_fetch,rest,AjaxModel,FetchModel,RestModel}

//导出默认对象
export default { paramFormat,ajax,secret,_fetch,rest,AjaxModel,FetchModel,RestModel}