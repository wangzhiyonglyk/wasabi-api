 ...
 */
 ...
 //导出对象
 export { paramFormat,ajax,secret,fetch,rest,AjaxModel,FetchModel,RestModel,crypto};
 
 //导出默认对象
 export default { paramFormat,ajax,secret,fetch,rest,AjaxModel,FetchModel,RestModel,crypto}